...
},{"../internals/export":"node_modules/core-js/internals/export.js","../internals/is-pure":"node_modules/core-js/internals/is-pure.js","../internals/global":"node_modules/core-js/internals/global.js","../internals/get-built-in":"node_modules/core-js/internals/get-built-in.js","../internals/native-promise-constructor":"node_modules/core-js/internals/native-promise-constructor.js","../internals/redefine":"node_modules/core-js/internals/redefine.js","../internals/redefine-all":"node_modules/core-js/internals/redefine-all.js","../internals/shared":"node_modules/core-js/internals/shared.js","../internals/set-to-string-tag":"node_modules/core-js/internals/set-to-string-tag.js","../internals/set-species":"node_modules/core-js/internals/set-species.js","../internals/is-object":"node_modules/core-js/internals/is-object.js","../internals/a-function":"node_modules/core-js/internals/a-function.js","../internals/an-instance":"node_modules/core-js/internals/an-instance.js","../internals/classof-raw":"node_modules/core-js/internals/classof-raw.js","../internals/iterate":"node_modules/core-js/internals/iterate.js","../internals/check-correctness-of-iteration":"node_modules/core-js/internals/check-correctness-of-iteration.js","../internals/species-constructor":"node_modules/core-js/internals/species-constructor.js","../internals/task":"node_modules/core-js/internals/task.js","../internals/microtask":"node_modules/core-js/internals/microtask.js","../internals/promise-resolve":"node_modules/core-js/internals/promise-resolve.js","../internals/host-report-errors":"node_modules/core-js/internals/host-report-errors.js","../internals/new-promise-capability":"node_modules/core-js/internals/new-promise-capability.js","../internals/perform":"node_modules/core-js/internals/perform.js","../internals/internal-state":"node_modules/core-js/internals/internal-state.js","../internals/is-forced":"node_modules/core-js/internals/is-forced.js","../internals/well-known-symbol":"node_modules/core-js/internals/well-known-symbol.js","../internals/v8-version":"node_modules/core-js/internals/v8-version.js"}],"node_modules/core-js/modules/es.promise.all-settled.js":[function(require,module,exports) {
'use strict';
var $ = require('../internals/export');
var aFunction = require('../internals/a-function');
var newPromiseCapabilityModule = require('../internals/new-promise-capability');
...
exports.histDays = exports.corsApiUrl = void 0;
// Add a CORS URL
var corsApiUrl = "https://cors-anywhere.herokuapp.com/"; // https://corsproxy.github.io/
// Number of history days

exports.corsApiUrl = corsApiUrl;
var histDays = 13;
exports.histDays = histDays;
...
var today = (0, _moment.default)(),
    yesterday = (0, _moment.default)().subtract(1, "days"),
    firstDay = (0, _moment.default)().subtract(config.histDays, "days"); // parse historical bitcoin data for the specified days range

function getHistBitcoin() {
  var bitcoinUrl, bitcoinReq, bitcoinData;
  return regeneratorRuntime.async(function getHistBitcoin$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          bitcoinUrl = "".concat(config.corsApiUrl, "https://api.coindesk.com/v1/bpi/historical/close.json?start=").concat(firstDay.format("YYYY-MM-DD"), "&end=").concat(yesterday.format("YYYY-MM-DD"));
          _context.prev = 1;
          _context.next = 4;
          return regeneratorRuntime.awrap(_axios.default.get(bitcoinUrl));

        case 4:
          bitcoinReq = _context.sent;
          bitcoinData = bitcoinReq.data;
          return _context.abrupt("return", bitcoinData.bpi);
...
function getCurBitcoin() {
  var bitcoinUrl, bitcoinReq, bitcoinData;
  return regeneratorRuntime.async(function getCurBitcoin$(_context2) {
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          bitcoinUrl = "".concat(config.corsApiUrl, "https://api.coindesk.com/v1/bpi/currentprice/USD.json");
          _context2.prev = 1;
          _context2.next = 4;
          return regeneratorRuntime.awrap(_axios.default.get(bitcoinUrl));

        case 4:
          bitcoinReq = _context2.sent;
          bitcoinData = bitcoinReq.data;
          return _context2.abrupt("return", bitcoinData.bpi);
...
function updateCurRow() {
  var table, curData;
  return regeneratorRuntime.async(function updateCurRow$(_context3) {
    while (1) {
      switch (_context3.prev = _context3.next) {
        case 0:
          table = document.getElementById("bitcoinTable");
          _context3.next = 3;
          return regeneratorRuntime.awrap(getCurBitcoin());

        case 3:
          curData = _context3.sent;
...
function populateTable() {
  var table, histData, _i, _Object$keys, key, row, cell1, cell2, curData, _row, _cell, _cell2;

  return regeneratorRuntime.async(function populateTable$(_context4) {
    while (1) {
      switch (_context4.prev = _context4.next) {
        case 0:
          ...
          _context4.prev = 1;
          _context4.next = 4;
          return regeneratorRuntime.awrap(getHistBitcoin());

        case 4:
          histData = _context4.sent;

          for (_i = 0, _Object$keys = Object.keys(histData); _i < _Object$keys.length; _i++) {
            key = _Object$keys[_i];
            row = table.insertRow(1), cell1 = row.insertCell(0), cell2 = row.insertCell(1);
            cell1.innerHTML = (0, _moment.default)(key, 'YYYY-MM-DD').format('DD MMM YYYY');
        ...
        case 14:
          curData = _context4.sent;
          _row = table.insertRow(1), _cell = _row.insertCell(0), _cell2 = _row.insertCell(1);
          _cell.innerHTML = (0, _moment.default)(today).format('DD MMM YYYY');
          _cell2.innerHTML = curData.USD.rate_float;
          _row.className = "mdc-data-table__row";
          _cell.className = "mdc-data-table__cell";
          _cell2.className = "mdc-data-table__cell mdc-data-table__cell--numeric";
          _context4.next = 26;
          break;
...
populateTable(); // update the row with the current data every 5 seconds

setInterval(updateCurRow, 5000);
},{"axios":"node_modules/axios/index.js","core-js/stable":"node_modules/core-js/stable/index.js","regenerator-runtime/runtime":"node_modules/regenerator-runtime/runtime.js","moment":"node_modules/moment/moment.js","./config":"config.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
